...
#DEVELOPED BY Mark NAVNATH

root = Tk()
root.title(" Hostel contact management   list")
width = 700
height = 400  
...
def OnSelected(event):
    ...
    UpdateWindow.title(" hostel Contact List")
    width = 400
    height = 300
    screen_width = root.winfo_screenwidth()
    screen_height = root.winfo_screenheight()
...
def AddNewWindow():
    ...
    CONTACT.set("")
    NewWindow = Toplevel()
    NewWindow.title("hostel management  List")
    width = 400
    height = 300
    screen_width = root.winfo_screenwidth()
    screen_height = root.winfo_screenheight()
...
#============================LABELS======================================
lbl_title = Label(Top, text=" hostel Contact Management System", font=('arial', 16), width=500)
lbl_title.pack(fill=X)
